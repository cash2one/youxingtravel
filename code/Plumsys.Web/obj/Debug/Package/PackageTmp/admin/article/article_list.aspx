...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><asp:LinkButton ID="btnAdd" runat="server" CssClass="add" href="article_edit.aspx?action=<%=PLEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增</span></asp:LinkButton></li>
