...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable focusNews = get_article_list("Carousel", 0, 8, "status=0 and is_slide=1 and img_url<>''");
	...
	DataTable PackageTour = get_article_list("PackageTour", 0, 4, "");

	foreach(DataRow dr in PackageTour.Rows)
	{

	templateBuilder.Append("\r\n        <li> <a title=\"" + Utils.ObjectToStr(dr["title"]) + "\" href=\"");
	templateBuilder.Append(linkurl("PackageTour_Detail",Utils.ObjectToStr(dr["id"])));
	...
	DataTable Walker = get_article_list("Walker", 0, 4, "");
	...
	DataTable Grogshop = get_article_list("Grogshop", 0, 4, "");

	foreach(DataRow dr in Grogshop.Rows)
	{

	templateBuilder.Append("\r\n        <li> <a title=\"" + Utils.ObjectToStr(dr["title"]) + "\" href=\"");
	templateBuilder.Append(linkurl("Grogshop_Detail",Utils.ObjectToStr(dr["id"])));
	...
	DataTable Ticket = get_article_list("Ticket", 0, 4, "");
	...
	DataTable Ploy = get_article_list("Ploy", 0, 4, "");
