...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(linkurl("tsearch","?category_id="+category_id+"&min_price="+minPrice+"&max_price="+maxPrice+"&area_id="+get_area_parent_id(Utils.ObjectToStr(adr["id"]))+"&orderby=click"+get_article_spec_param(dicSpecIds,"")));
	...
	templateBuilder.Append(linkurl("tsearch","?category_id="+get_category_parent_id(Utils.ObjectToStr(gdr["id"]))+"&min_price="+minPrice+"&max_price="+maxPrice+"&area_id="+area_id+"&orderby=click"+get_article_spec_param(dicSpecIds,"")));
	...
	templateBuilder.Append("\r\n                                    <a href='");
	templateBuilder.Append(linkurl("tsearch","?category_id="+category_id+"&min_price="+minPrice+"&max_price="+maxPrice+"&area_id="+Utils.ObjectToStr(cdr["id"])+"&orderby=click"+get_article_spec_param(dicSpecIds,"")));
	...
	templateBuilder.Append("<%linkurl(\"tsearch\",\"?category_id=\"+category_id+\" &min_price=\"+minPrice+\" &max_price=\"+maxPrice+\" &orderby=time\"+get_article_spec_param(dicSpecIds,\"\"))%>");
	templateBuilder.Append("'>销量优先</a>\r\n                                            ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n                                            <a class=\"selected\" href='");
	templateBuilder.Append("<%linkurl(\"tsearch\",\"?category_id=\"+category_id+\" &min_price=\"+minPrice+\" &max_price=\"+maxPrice+\" &orderby=max\"+get_article_spec_param(dicSpecIds,\"\"))%>");
	...
	templateBuilder.Append("\r\n                                            <a class=\"selected\" href='");
	templateBuilder.Append("<%linkurl(\"tsearch\",\"?category_id=\"+category_id+\" &min_price=\"+minPrice+\" &max_price=\"+maxPrice+\" &orderby=min\"+get_article_spec_param(dicSpecIds,\"\"))%>");
	...
	templateBuilder.Append("<!--数据-->\r\n                                ");
	 pagelist = Utils.OutPageList(pagesize, page, totalcount, linkurl("tourist_mall_list", "?category_id="+category_id+"&min_price="+minPrice+"&max_price="+maxPrice+"&orderby="+strBy+"&page=__id__"+get_article_spec_param(dicSpecIds,"")), 8);
	...
	templateBuilder.Append("\r\n                                <div class=\"clear\"></div>\r\n                            </div><!-- 筛选结果 end -->                 <!-- 分页开始 -->\r\n\r\n                            <div class=\"page\">\r\n                                <!--<a href=\"javascript:void();\">上一页</a>\r\n                                <a class=\"hover\" href=\"javascript:void();\">1</a>\r\n                                <a href=\"#\">2</a>\r\n                                <a href=\"#\">3</a>\r\n                                <a href=\"#\">4</a>\r\n                                <a href=\"#\">5</a>\r\n                                <a href=\"#\">6</a>\r\n                                <a href=\"#\">7</a>\r\n                                ...   <a href=\"#\">下一页</a>-->\r\n                                ");
