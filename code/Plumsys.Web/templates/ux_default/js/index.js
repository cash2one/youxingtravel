...
function common_number(e, t) {
    ...
    for (var r = e.length, o = "", s = 0; r / 3 + 1 > s; s++) 0 >= r - 3 * (s + 1) ? o = e.substring(0, r - 3 * s) + o : o += "," + e.substring(r - 3 * (s + 1), r - 3 * s);
...
function common_post(e, t) {
    ...
    n.action = e, n.method = "post", n.style.display = "none";
    for (var i in t) {
        var r = document.createElement("textarea");
        r.name = i, r.value = t[i], n.appendChild(r)
    }
...
function loginMemue(e) {
    $("#au_login").show(), $("#un_login").hide(), -1 != e.indexOf("userOrderList") || -1 != e.indexOf("userInfo") || -1 != e.indexOf("userOrderDetail") || -1 != e.indexOf("userPassword") || -1 != e.indexOf("userCoupons") || -1 != e.indexOf("userTravel") ? $("#U_ROLE_USER").addClass("topbar_hover") : $("#U_ROLE_USER").addClass("widthB")
}
...
function translate(e, t) {
    e = e.childNodes;
    for (var n, i = 0, r = e.length; r > i; i++) if (n = e.item(i), !("||BR|HR|TEXTAREA|".indexOf("|" + n.tagName + "|") > 0)) if (n.title && (n.title = t(n.title)), n.alt && (n.alt = t(n.alt)), "INPUT" == n.tagName) {
        if (n.getAttribute("api") && "1" == n.getAttribute("api")) continue;
        "INPUT" == n.tagName && "" != n.value && "text" != n.type && "hidden" != n.type && (n.value = t(n.value)), n.placeholder && (n.placeholder = t(n.placeholder)), n.getAttribute("cn") && n.setAttribute("cn", t(n.getAttribute("cn"))), n.getAttribute("data-name") && n.setAttribute("data-name", t(n.getAttribute("data-name")))
...
function translateText(e, t) {
    if (null != e) {
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++) n = e.charAt(s), i = t ? simplified.indexOf(n) : traditional.indexOf(n), r = t ? traditional.charAt(i) : simplified.charAt(i), o.push(-1 != i ? r : n);
        return o.join("")
    }
}
function initCurreny() {
    var e = Cookie.get("CurrencyType");
    null != e && "0" != e || $(".currenyTag").text("人民币"), "1" == e && $(".currenyTag").text("美元"), "2" == e && $(".currenyTag").text("欧元"), "3" == e && $(".currenyTag").text("英镑"), "9" == e && $(".currenyTag").text("港币"), "10" == e && $(".currenyTag").text("新元"), "12" == e && $(".currenyTag").text("台币")
}
...
jQuery.cookie = function (e, t, n) {
    ...
    if (n.expires && ("number" == typeof n.expires || n.expires.toUTCString)) {
        var u;
        "number" == typeof n.expires ? (u = new Date, u.setTime(u.getTime() + 24 * n.expires * 60 * 60 * 1e3)) : u = n.expires, a = "; expires=" + u.toUTCString()
    }
    var l = n.path ? "; path=" + n.path : "",
		c = n.domain ? "; domain=" + n.domain : "",
		h = n.secure ? "; secure" : "";
    document.cookie = [e, "=", encodeURIComponent(t), a, l, c, h].join("")
}, function (e, t, n, i) {
    var r = e(t);
    e.fn.lazyload = function (o) {
        ...
        return o && (i !== o.failurelimit && (o.failure_limit = o.failurelimit, delete o.failurelimit), i !== o.effectspeed && (o.effect_speed = o.effectspeed, delete o.effectspeed), e.extend(l, o)), a = l.container === i || l.container === t ? r : e(l.container), 0 === l.event.indexOf("scroll") && a.bind(l.event, function () {
            return s()
        }), this.each(function () {
            var t = this,
				n = e(t);
...
}(jQuery, window, document), String.prototype.startWith = function (e) {
    var t = new RegExp("^" + e);
    return t.test(this)
    ...
    var t = "0.9.3",
		...
		o = function () {
		    ...
		    return s = o && window.JSON ? {
		        ...
		        set: function (e, r, s) {
		            return n.isNumber(s) ? o.setItem(this._ttlKey(e), i(t() + s)) : o.removeItem(this._ttlKey(e)), o.setItem(this._prefix(e), i(r))
		        },
		        remove: function (e) {
		...
		a = function () {
		    function t(e) {
		        n.bindAll(this), e = n.isString(e) ? {
		            url: e
		        } : e, u = u || new s, a = n.isNumber(e.maxParallelRequests) ? e.maxParallelRequests : a || 6, this.url = e.url, this.wildcard = e.wildcard || "%QUERY", this.filter = e.filter, this.replace = e.replace, this.ajaxSettings = {
		            type: "get",
		            cache: e.cache,
		            timeout: e.timeout,
		    ...
		    return n.mixin(t.prototype, {
		        ...
		        _sendRequest: function (t) {
		            ...
		            var o = this,
						s = c[t];
		            return s || (i(), s = c[t] = e.ajax(t, this.ajaxSettings).always(n)), s
		        },
		        get: function (e, t) {
		            var i, r, o = this,
						s = encodeURIComponent(e || "");
		            return t = t || n.noop, i = this.replace ? this.replace(this.url, s) : this.url.replace(this.wildcard, s), (r = u.get(i)) ? n.defer(function () {
		    ...
		    return n.mixin(i.prototype, {
		        ...
		        _loadPrefetchData: function (i) {
		            function r(e) {
		                var t = i.filter ? i.filter(e) : e,
							...
							o = r.itemHash,
							a = r.adjacencyList;
		                d.storage && (d.storage.set(s.itemHash, o, i.ttl), d.storage.set(s.adjacencyList, a, i.ttl), d.storage.set(s.thumbprint, f, i.ttl), d.storage.set(s.protocol, n.getProtocol(), i.ttl)), d._mergeProcessedData(r)
		            }
		            var o, a, u, l, c, h, d = this,
						f = t + (i.thumbprint || "");
		            return this.storage && (o = this.storage.get(s.thumbprint), a = this.storage.get(s.protocol), u = this.storage.get(s.itemHash), l = this.storage.get(s.adjacencyList)), c = o !== f || a !== n.getProtocol(), i = n.isString(i) ? {
		                url: i
		            } : i, i.ttl = n.isNumber(i.ttl) ? i.ttl : 864e5, u && l && !c ? (this._mergeProcessedData({
		                itemHash: u,
		                adjacencyList: l
		            }), h = e.Deferred().resolve()) : h = e.getJSON(i.url).done(r), h
		        },
		        ...
		        _processData: function (e) {
		            ...
		            return n.each(e, function (e, o) {
		                ...
		                i[a] = s, n.each(s.tokens, function (e, t) {
		                    var i = t.charAt(0),
								o = r[i] || (r[i] = [a]);
		        ...
		        _getLocalSuggestions: function (e) {
		            ...
		            return n.each(e, function (e, t) {
		                ...
		                var a, u, l = i.itemHash[r];
		                a = n.every(o, function (e) {
		                    return ~n.indexOf(e, r)
		                }), u = a && n.every(e, function (e) {
		...
		c = function () {
		    ...
		    return n.mixin(t.prototype, i, {
		        ...
		        _moveCursor: function (e) {
		            var t, n, i, o;
		            if (this.isVisible()) {
		                if (t = this._getSuggestions(), n = t.filter(".tt-is-under-cursor"), n.removeClass("tt-is-under-cursor"), i = t.index(n) + e, i = (i + 1) % (t.length + 1) - 1, -1 === i) return void this.trigger("cursorRemoved"); -1 > i && (i = t.length - 1), o = t.eq(i).addClass("tt-is-under-cursor"), this._ensureVisibility(o), this.trigger("cursorMoved", r(o))
		            }
		        },
		        ...
		        renderSuggestions: function (t, i) {
		            var r, a, u, l, c, h = "tt-dataset-" + t.name,
						d = '<div class="tt-suggestion">%body</div>',
						f = this.$menu.find("." + h);
		            0 === f.length && (a = e(o.suggestionsList).css(s.suggestionsList), f = e("<div></div>").addClass(h).append(t.header).append(a).append(t.footer).appendTo(this.$menu)), i.length > 0 ? (this.isEmpty = !1, this.isOpen && this._show(), u = document.createElement("div"), l = document.createDocumentFragment(), n.each(i, function (n, i) {
		                i.dataset = t.name, r = t.template(i.datum), u.innerHTML = d.replace("%body", r), c = e(u.firstChild).css(s.suggestion).data("suggestion", i), c.children().each(function () {
		                    e(this).css(s.suggestionChild)
		                }), l.appendChild(c[0])
		            }), f.show().find(".tt-suggestions").html(l)) : this.clearSuggestions(t.name), this.trigger("suggestionsRendered")
		        },
		...
		h = function () {
		    ...
		    return n.isMsie() && n.mixin(a.query, {
		        ...
		        _updateHint: function () {
		            ...
		            a && u && !l && (e = this.inputView.getInputValue(), t = e.replace(/\s{2,}/g, " ").replace(/^\s+/g, ""), i = n.escapeRegExChars(t), r = new RegExp("^(?:" + i + ")(.*$)", "i"), o = r.exec(a), this.inputView.setHintValue(e + (o ? o[1] : "")))
		        },
		        _clearHint: function () {
		        ...
		        _getSuggestions: function () {
		            ...
		            t = t.replace(/(^\s*)|(\s*$)/g, ""), n.isBlankString(t) || n.each(this.datasets, function (n, i) {
...
}), locationCountryUrl(), window.onerror = function (e, t, n, i, r) { }, $("#uloginout").click(function () {
...
"true" == $.cookie("uloginflag") ? loginMemue(thisPageUrl) : $.ajax({
...
}), 1 == $.cookie("closeAppAd") ? $("#footer-app-download-div").hide() : $("#footer-app-download-div").show(), $("#footer_app_phone_del").click(function () {
    var e = new Date;
    e.setTime(e.getTime() + 12096e5), $.cookie("closeAppAd", 1, {
        path: "/",
        expires: e
    ...
    e.fn.hoverIntent = function (t, n, i) {
        ...
        var o, s, a, u, l = function (e) {
            o = e.pageX, s = e.pageY
        },
			c = function (t, n) {
			    return n.hoverIntent_t = clearTimeout(n.hoverIntent_t), Math.abs(a - o) + Math.abs(u - s) < r.sensitivity ? (e(n).off("mousemove.hoverIntent", l), n.hoverIntent_s = 1, r.over.apply(n, [t])) : (a = o, u = s, n.hoverIntent_t = setTimeout(function () {
			        c(t, n)
			    }, r.interval), void 0)
			},
			h = function (e, t) {
			...
			d = function (t) {
			    var n = jQuery.extend({}, t),
					i = this;
			    i.hoverIntent_t && (i.hoverIntent_t = clearTimeout(i.hoverIntent_t)), "mouseenter" == t.type ? (a = n.pageX, u = n.pageY, e(i).on("mousemove.hoverIntent", l), 1 != i.hoverIntent_s && (i.hoverIntent_t = setTimeout(function () {
			        c(n, i)
			    }, r.interval))) : (e(i).off("mousemove.hoverIntent", l), 1 == i.hoverIntent_s && (i.hoverIntent_t = setTimeout(function () {
			        h(n, i)
			    }, r.timeout)))
			};
        return this.on({
    ...
    var t = function () {
        var t = {
            ...
            u = function (t, r) {
                ...
                e.fn.hoverIntent && !r.disableHI ? t.hoverIntent(c, h, o) : t.on("mouseenter.superfish", o, c).on("mouseleave.superfish", o, h);
                var s = "MSPointerDown.superfish";
                n || (s += " touchend.superfish"), i && (s += " mousedown.superfish"), t.on("focusin.superfish", "li", c).on("focusout.superfish", "li", h).on(s, "a", r, l)
            },
            l = function (t) {
                var n = e(this),
            ...
            d = function (t) {
                t.retainPath = e.inArray(this[0], t.$path) > -1, this.superfish("hide"), this.parents("." + t.hoverClass).length || (t.onIdle.call(f(this)), t.$path.length && e.proxy(c, t.$path)())
            },
            f = function (e) {
        ...
        return {
            hide: function (e) {
                if (this.length) {
                    ...
                    var i = n.retainPath === !0 ? n.$path : "",
                        ...
                        o = n.speedOut;
                    e && (r.show(), o = 0), n.retainPath = !1, n.onBeforeHide.call(r), r.hide(0)
                }
                return this
            },
            show: function () {
                ...
                if (e.hoverStyle) {
                    ...
                    if (r > i) {
                        var o = this.innerHeight(),
                            ...
                            a = o * s;
                        e.toTopMargin && (a += e.toTopMargin), n.css({})
                    } else this.children("ul").css(e.hoverStyle)
                }
                var u = this.addClass(e.hoverClass),
                    l = u.children(e.popUpSelector);
                return e.onBeforeShow.call(l), l.show(0), this
            },
            destroy: function () {
                return this.each(function () {
                    var n, i = e(this),
                        o = i.data("sf-options");
                    return o ? (n = i.find(o.popUpSelector).parent("li"), clearTimeout(o.sfTimer), r(i, o), s(n), a(i), i.off(".superfish").off(".hoverIntent"), n.children(o.popUpSelector).attr("style", function (e, t) {
            ...
            init: function (n) {
                return this.each(function () {
                    ...
                    var l = e.extend({}, e.fn.superfish.defaults, n),
                        c = i.find(l.popUpSelector).parent("li");
                    l.$path = o(i, l), i.data("sf-options", l), r(i, l), s(c), a(i), u(i, l), c.not("." + t.bcClass).superfish("hide", !0), l.onInit.call(this)
                })
            }
        }
    }();
...
}(jQuery), $("#dropdown_menu").superfish({
    speed: "fast",
    speedOut: "fast",
    delay: "100",
    disableHI: !0
}), $("li #weixin_down").mouseenter(function () {
    $(this).parent().css("border-bottom", "none"), $(this).next().show(), $(this).addClass("wx-hover")
}), $("#weixin_block").mouseleave(function () {
    $("#weixin_appear").hide(), $("#weixin_down").removeClass("wx-hover")
}), $("#phone_down").mouseenter(function () {
    $(this).parent().css("border-bottom", "none"), $(this).next().show(), $(this).addClass("wx-hover")
}), $("#phone_block").mouseleave(function () {
    $("#phone_appear").hide(), $("#phone_down").removeClass("wx-hover")
});
var moreSelected = !0,
...
if ($themeChildren.each(function () {
    ...
    $categorys.css("cursor", "pointer"), $categorys.addClass("down"), $categorys.mouseenter(function () {
        $(this).removeClass("down"), $(this).addClass("up")
    }), $categorys.mouseleave(function () {
        $(this).addClass("down"), $(this).removeClass("up")
    })
} -1 != window.location.pathname.indexOf("sales.html") && ($themeChildren.removeClass("selected"), $themeChildren.removeClass("hover"), $(".header_themlist").find(".flashsales_hot").addClass("selected")), $(".header_tel_top").mouseenter(function () {
    $(this).children().eq(0).addClass("tel-hover"), $(this).children().eq(1).show()
}), $(".header_tel_top").mouseleave(function () {
    $(this).children().eq(0).removeClass("tel-hover"), $(this).children().eq(1).hide()
}), $(".moreitems").mouseenter(function () {
    var e = $(this).children();
    e.eq(1).show(), e.eq(0).addClass("up")
}), $(".moreitems").mouseleave(function () {
    var e = $(this).children();
    e.eq(1).hide(), e.eq(0).removeClass("up")
}), $(".header_themlist").children().each(function () {
    var e = $(this).find(".navitems_content");
    $(this).on("mouseenter", function () {
        $(this).addClass("hover"), e.show()
    }), $(this).on("mouseleave", function () {
        e.hide(), $(this).removeClass("hover")
    })
...
window.toChinese = function () {
    Cookie.set(cookieName, "tw"), window.location.reload()
}, window.toSimpleChinese = function () {
    Cookie.set(cookieName, "cn"), window.location.reload()
};
var Cookie = {
    set: function (e, t) {
        var n = new Date;
        n.setDate(n.getDate() + 6e5), document.cookie = e + "=" + escape(t) + ";path=/;expires=" + n.toGMTString()
    },
    del: function (e) {
...
initCurreny(), initLanguage(), $(function () {
    initLanguage()
...
}), "tw" == Cookie.get("language")) {
    var text = traditionalized($(".AdviseText").attr("placeholder"));
    $(".AdviseText").attr("placeholder", text)
}
$.ajax({
    type: "post",
